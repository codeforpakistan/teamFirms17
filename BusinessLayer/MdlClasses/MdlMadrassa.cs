...
namespace BusinessLayer.MdlClasses
{
    ...
    { 
        ...
        public DateTime MadrassaStartDate { get; set; }
        public string MadrassaStartDateString { get; set; }
     ...
     public int BankID { get; set; }
        ...
        public List<Dropdownlist> SectTypeDrp = new List<Dropdownlist>();
