...
{
    public class MdlFirm
    {
       public string  OrgRegName{get;set;}
        ...
        public DateTime FirmStartDate { get; set; }
        public string FirmStartDateString { get; set; }
        ...
        public DateTime DeedAgreementDate { get; set; }
        public string DeedAgreementDateString { get; set; }
        ...
        public long ExistingOrgDocID { get; set; }
        public string OrgTypeName { get; set; }

        public string FormHPath { get; set; }

        public string FormAgmtPath { get; set; }
      ...
      public  List<Dropdownlist> BussinessType = new List<Dropdownlist>();
       ...
       public List<Dropdownlist> GetAllBankList = new List<Dropdownlist>();
