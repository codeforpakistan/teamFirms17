<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RptSocietyDetails.aspx.cs" Inherits="ProjectFirms01.Reports.RptSocietyDetails" %>
           ...
           <ContentTemplate>
               ...
               <div>         
                    <rsweb:ReportViewer ID="RpvFirms" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Width="100%">
                        <LocalReport ReportPath="RDLCs\ReportGetSocietyDetails.rdlc" EnableHyperlinks="true" >
                        <DataSources>
