<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RptGetPartnersofFirm.aspx.cs" Inherits="ProjectFirms01.Reports.RptGetPartnersofFirm" %>
           ...
           <ContentTemplate>
               ...
               <div>         
                    <rsweb:ReportViewer ID="RpvPartner" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Width="100%">
                        <LocalReport ReportPath="RDLCs\RptPartnersofFirm.rdlc" EnableHyperlinks="true" >
                        <DataSources>
                            <rsweb:ReportDataSource DataSourceId="SqlDataSource1" Name="DataSet1" />
                        </DataSources> 
                            </LocalReport>
                    </rsweb:ReportViewer>
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:dbFirmsConnectionString %>" SelectCommand="usp_GetPartnersofOrganizationUsingFileNo" SelectCommandType="StoredProcedure" >
                        <SelectParameters>
