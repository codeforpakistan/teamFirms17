<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RptMadrassaDetails.aspx.cs" Inherits="ProjectFirms01.Reports.RptMadrassaDetails" %>
           ...
           <ContentTemplate>
               ...
               <div>         
                    <rsweb:ReportViewer ID="RpvFirms" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Width="100%">
                        <LocalReport ReportPath="RDLCs\ReportGetMadrassaDetails.rdlc" EnableHyperlinks="true" >
                        <DataSources>
